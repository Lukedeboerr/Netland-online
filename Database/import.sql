...
INSERT INTO films (titel, duur, datum, land, description)
VALUES ('Finding Nemo', '1:40', '2003/27/11', 'Verenigde Staten', 'A tale which follows the comedic and eventful journeys of two fish, the fretful Marlin and his young son Nemo, who are separated from each other in the Great Barrier Reef when Nemo is unexpectedly taken from his home and thrust into a fish tank in a dentists office overlooking Sydney Harbor.');

INSERT INTO films (titel, duur, datum, land, description)
VALUES ('Finding Dory', '1:37', '2016/29/6', 'Verenigde Staten', 'Dory is a wide-eyed, blue tang fish who suffers from memory loss every 10 seconds or so. The one thing she can remember is that she somehow became separated from her parents as a child. With help from her friends Nemo and Marlin, Dory embarks on an epic adventure to find them.');

INSERT INTO films(titel, duur, datum, land, description)
VALUES ('Cars 1', '2:10', '2009/15/8', 'UK', 'The story of Cars is set in an alternate universe where every character is a vehicle of various sorts, whether that be an automobile, an aircraft and a watercraft. The film focuses on a rookie race car named Lightning McQueen who discovers the lost town of Radiator Springs on his way to the biggest race of his life.');

INSERT INTO films (titel, duur, datum, land, description)
VALUES ('Cars 2', '1:54', '2011/12/24', 'UK', 'The story of Cars is set in an alternate universe where every character is a vehicle of various sorts, whether that be an automobile, an aircraft and a watercraft. The film focuses on a rookie race car named Lightning McQueen who discovers the lost town of Radiator Springs on his way to the biggest race of his life.');

INSERT INTO films(titel, duur, datum, land, description) 
VALUES ('Cars 3', '2:46', '2017/10/3', 'UK', 'The story of Cars is set in an alternate universe where every character is a vehicle of various sorts, whether that be an automobile, an aircraft and a watercraft. The film focuses on a rookie race car named Lightning McQueen who discovers the lost town of Radiator Springs on his way to the biggest race of his life.');